...
public class MultiSelectListPreference extends AbstractMultiSelectListPreference {
    ...
    public MultiSelectListPreference(
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs,
                androidx.preference.R.styleable.MultiSelectListPreference, defStyleAttr,
                defStyleRes);

        mEntries = TypedArrayUtils.getTextArray(a,
                androidx.preference.R.styleable.MultiSelectListPreference_entries,
                androidx.preference.R.styleable.MultiSelectListPreference_android_entries);

        mEntryValues = TypedArrayUtils.getTextArray(a,
                androidx.preference.R.styleable.MultiSelectListPreference_entryValues,
                androidx.preference.R.styleable.MultiSelectListPreference_android_entryValues);
